			...
			if (label.equalsIgnoreCase("get")
				...
				if (args.length == 0) {
					player.sendMessage(ChatColor.GRAY
							+ "/get [doors], [egg], [furnace], [logs], [mushrooms], [slabs #]");
					return true;
				}
				if (args[0].equalsIgnoreCase("eggs")
						|| args[0].equalsIgnoreCase("egg")) {
					if (sender.hasPermission("BuildFixes.eggs")) {
				...
				if ((args[0].equalsIgnoreCase("doors") || args[0]
					...
					if (sender.hasPermission("BuildFixes.doors")) {
						player.getInventory().addItem(
				...
				if (args[0].equalsIgnoreCase("furnaces")
						|| args[0].equalsIgnoreCase("furnace")) {
					if (sender.hasPermission("BuildFixes.furnace")) {
						player.getInventory().addItem(
				...
				if ((args[0].equalsIgnoreCase("logs") || args[0]
					...
					if (sender.hasPermission("BuildFixes.logs")) {
						player.getInventory().addItem(
				...
				if (args[0].equalsIgnoreCase("lamps")
					...
					if (sender.hasPermission("BuildFixes.lamps")) {
						player.getInventory().addItem(
				...
				if ((args[0].equalsIgnoreCase("mushrooms") || args[0]
					...
					if (sender.hasPermission("BuildFixes.mushrooms")) {
						player.getInventory().addItem(
				...
				if ((args[0].equalsIgnoreCase("slabs") || args[0]
					...
					if (sender.hasPermission("BuildFixes.slabs")) {
						if (args.length > 1) {
							String str = args[1];
							if (str == null) {
								return false;
